    ...
    <section class="ProductsSection">
        ...
        <div class="products">
          <div class="product-card">
            <img class="product-image" src="assets/headphones1.webp"Product 1">
            <div class="product-details">
              <h3 class="product-title">Stylish Headphones</h3>
          ...
          <div class="product-card">
            <img class="product-image" src="assets/iphone15.webp" alt="Product 2" />
            <div class="product-details">
          ...
          <div class="product-card">
            <img class="product-image" src="assets/smartwatch1.webp" alt="Product 3" />
            <div class="product-details">
              <h3 class="product-title">Fashionable Smartwatch</h3>
              <p class="product-price">$149.99</p>
              <button class="buy-button">Buy Now</button>
            </div>
          </div>
        </div>
        <button class="show-all-button" onclick="window.location.href='products.html'">Show All Products</button>
      </section>
      <section class="TeamSection">
        <div class="team">
          ...
          <div>
            ...
            <p>
              Mollyjogger™ is an authentic American heritage brand, based in the <br>
              Ozark Mountains, celebrating the region’s unique history of outdoor <br>
