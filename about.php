...
.review-container {
  ...
  overflow: hidden;
  position: relative;
  height: 300px; /* Set a fixed height for the review container */
}
...
.prev {
  left: 25%; /* Adjust this value for left positioning */
  border-radius: 3px 0 0 3px;
}

.next {
  right: 25%; /* Adjust this value for right positioning */
  border-radius: 0 3px 3px 0;
}
